 ...
 * @LastEditTime: 2022-11-05 21:08:43
 * @Description: 
-->
<template>
  <div v-rightMenu class="home-record">
    ...
    <DialogForm v-if="showForm" ref="dialogForm" width="400" :buttons="{ comfirm: '确 认', cancel: '取 消' }" :title="title" :visible.sync="showForm" :formData="formData" :formMap="formMap" :formRule="formRule" @comfirmForm="save" @cancelForm="cancel"></DialogForm>
