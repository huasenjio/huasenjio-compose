<template>
  <div class="browser-tips-group">
    ...
    <a v-for="item in tips" :key="item.name" class="icon" target="_blank" :href="item.url" :class="item.name">
  ...
  data() {
    return {
      tips: [
        {
          name: 'chrome',
          img: require('./img/browser-tips/chrome.png'),
          url: 'https://www.google.com/intl/zh-CN/chrome/',
        },
        {
          name: 'edge',
          img: require('./img/browser-tips/edge.png'),
          url: 'https://www.microsoft.com/zh-cn/edge',
        },
        {
          name: 'safari',
          img: require('./img/browser-tips/safari.png'),
...
.browser-tips-group {
  ...
  background-image: url('./img/browser-tips/no-support.png');
