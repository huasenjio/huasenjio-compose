...
const { findAll, findAllIcon, remove, downloadStore, uploadFileToStore } = require('../controller/file.controller.js');
...
router.post('/downloadStore', handleJWT(), checkManagePower, downloadStore);
